...
class LineshapeFactory:
    ...
    def __init__(self, spectra: Spectra, config: FitConfig) -> None:
    ...
    def create(
        ...
        *,
        ...
        shape_provider = self._resolve_shape_provider(shape_type)

        return shape_provider(peak_name, center, self._spectra, dim, self._config)
    ...
    def _resolve_shape_provider(self, shape_type: str) -> Callable[..., Shape]:
        try:
