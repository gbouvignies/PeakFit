...
- **[CLI UI Design Notes](development/cli_ui_specification.md)** - Terminal workflow principles and examples
- **[Terminal Output Principles](development/terminal-output-style-guide.md)** - Console output conventions and examples
